...
**Integration checks**:
- [ ] BaseModule methods work correctly
...
- `pkg/runner/runner_test.go` - Test mode propagation

**Integration checks**:
- [ ] CLI flags work correctly
- [ ] Modes propagate to modules
- [ ] No performance regression

**Commit message**: `step3: add check/diff mode flags to CLI and runner`
...
**Files to create**:
- `pkg/testing/module_helper.go` - Test helper framework
- `pkg/testing/mock_connection.go` - Mock connection
- `pkg/testing/mock_filesystem.go` - Mock file system
- `pkg/testing/module_helper_test.go` - Test the helper
